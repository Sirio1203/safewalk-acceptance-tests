# language: es
Característica: Reportes colaborativos de incidentes
  Como ciudadano
  Deseo reportar incidentes desde la aplicación
  Para alertar a otros usuarios sobre zonas de riesgo
  
#------------------------------------------------------------------------------------------------
  Escenario: E01 - Reportar un incidente de seguridad
...
#------------------------------------------------------------------------------------------------
  Escenario: E02 - Adjuntar evidencia al reporte
...
#------------------------------------------------------------------------------------------------
  Escenario: E03 - Reportar una luminaria malograda
...
#------------------------------------------------------------------------------------------------
  Escenario: E04 - Ver reportes recientes cerca de mi ubicación
...
#------------------------------------------------------------------------------------------------
  Escenario: E05 - Reportar presencia sospechosa
...
#------------------------------------------------------------------------------------------------
  Escenario: E06 - Calificar utilidad de un reporte
